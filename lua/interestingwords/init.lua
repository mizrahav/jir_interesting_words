...
m.InterestingWord = function(mode, search, partial)
    local word = ''
    if mode == 'v' then
...
m.setup = function(opt)
    ...
    if m.config.partial_color_key then
        vim.keymap.set("n", m.config.partial_color_key, function()
            m.InterestingWord('n', false, true)
        end, { noremap = true, silent = true, desc = "InterestingWord Toggle Color" })
        vim.keymap.set("x", m.config.partial_color_key, function()
            m.InterestingWord('v', false, false)
        end, { noremap = true, silent = true, desc = "InterestingWord Toggle Color" })
    end
